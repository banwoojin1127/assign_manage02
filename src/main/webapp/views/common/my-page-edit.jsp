...
<!-- stylesheet group start -->
    ...
    <link rel="stylesheet" href="../../resources/css/prefab_wide_v01.2.css"/>
        ...
        <div id="navSideBar" class="accordion accordion-flush" style="background-color: #223964;">
            ...
            <div id="accordionSnd" class="defCollaps accordion-item">
                ...
                <div id="collapseSnd" class="defCollaps accordion-collapse collapse" style="border-style:none;" data-bs-parent="#navSideBar">
                    <div id="" class="accordion-body row row-cols-2 m-0 p-0" style="width: 100%">
                        <a href="../teacher/teacher-main.html" id="" class="btn d-flex col flex-wrap justify-content-center align-content-center h-50" style="width: 97%; font-weight: bold;">
                            <span>교사</span>
                        </a>
                        <div class="blank d-flex col flex-wrap m-0 p-0" style="width: 3%;"></div>
                    </div>
            ...
            <div id="accordionTrd" class="defCollaps accordion-item">
                ...
                <div id="collapseTrd" class="defCollaps accordion-collapse collapse" style="border-style:none;" data-bs-parent="#navSideBar">
                    <div id="" class="accordion-body row row-cols-2 m-0 p-0" style="width: 100%">
                        <a href="../student/stundent-main.html" id="" class="btn d-flex col flex-wrap justify-content-center align-content-center h-50" style="width: 97%; font-weight: bold;">
                            <span>학생</span>
                        </a>
                        <div class="blank d-flex col flex-wrap m-0 p-0" style="width: 3%;"></div>
                    </div>
            ...
            <form style="margin: 0 400px; font-size: 20px;">
                ...
                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                    <div style="text-align: center; margin-left: 37%;">
                        <a href="../common/my-page.html" type="button" class="btn btn-danger" style="font-size: 18px; padding-block: 5px;">취소</a> &nbsp; &nbsp;
                        <a href="../common/my-page.html" type="button" class="btn btn-primary" style="font-size: 18px; padding-block: 5px;">저장</a>
                    </div>
                </div>
                <br><br>
            </form>
