...
<!-- content field start -->
        <div style="padding: 80px 130px; text-align: center; width: 1649px;">
            ...
            <form style="margin: 0 400px; font-size: 20px;">
                ...
                <br><br>
                <div>
                    <a href="../common/my-page-auth.html" class="btn btn-primary align-content-center" style="font-size: 18px; padding-block: 5px;">수정</a>
                </div><br>
                    <div style="text-align: right;">
                    <a href="../common/login.html" type="button" class="btn btn-link"
